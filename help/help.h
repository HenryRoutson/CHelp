...
void free_sans_null(void *pointer, char *file_name, size_t line_number);
...
#define free_sans_null(pointer) free_sans_null((void *)pointer, __FILE__, __LINE__)
...
#define free_sans_null(pointer) free(pointer)
